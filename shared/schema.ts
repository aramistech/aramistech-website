...
export const securityAlerts = pgTable("security_alerts", {
  ...
  backgroundColor: varchar("background_color", { length: 50 }).notNull().default("#dc2626"),
  textColor: varchar("text_color", { length: 50 }).notNull().default("#ffffff"),
