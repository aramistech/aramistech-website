          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="group border-white text-orange-500 hover:bg-white hover:text-blue-600 px-8 py-4 text-lg"
                onClick={() => window.open('tel:+15613682196', '_self')}
              >
                <Phone className="w-5 h-5 mr-2 text-orange-500 group-hover:text-blue-600" />
                Call Now: <span className="text-aramis-orange group-hover:text-blue-600">(305) 814-4461</span>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="group border-white text-white hover:bg-white hover:text-primary-blue px-8 py-4 text-lg"
              onClick={() => window.open('tel:+13058144461', '_self')}
            >
              <svg className="w-5 h-5 mr-2 group-hover:stroke-blue-600" fill="none" viewBox="0 0 24 24" stroke="#f97316" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span className="text-aramis-orange group-hover:text-primary-blue">(305) 814-4461</span>
            </Button>
          </div>
        </div>
      </div>
