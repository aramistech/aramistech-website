...
import { Plus, Edit2, Trash2, DollarSign, Package, List } from "lucide-react";
...
export default function ServiceCalculatorManager() {
  ...
  return (
    <div className="space-y-6">
      <Tabs defaultValue="categories" className="space-y-6">
        ...
        {/* Service Options Tab - simplified for space */}
